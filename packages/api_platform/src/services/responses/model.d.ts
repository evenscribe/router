...
export interface components {
  schemas: {
    ...
    AssistantMessageItemParam: {
      ...
      content:
        | (
            | components["schemas"]["OutputTextContentParam"]
            | components["schemas"]["RefusalContentParam"]
          )[]
        | string;
      status?: string | null;
    };
    ...
    TextFormatParam:
      | components["schemas"]["TextResponseFormat"]
      | components["schemas"]["JsonSchemaResponseFormatParam"];
  };
  responses: never;
  parameters: never;
  requestBodies: never;
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          ...
          "text/event-stream":
            | components["schemas"]["ResponseCreatedStreamingEvent"]
            | components["schemas"]["ResponseQueuedStreamingEvent"]
            | components["schemas"]["ResponseInProgressStreamingEvent"]
            | components["schemas"]["ResponseCompletedStreamingEvent"]
            | components["schemas"]["ResponseFailedStreamingEvent"]
            | components["schemas"]["ResponseIncompleteStreamingEvent"]
            | components["schemas"]["ResponseOutputItemAddedStreamingEvent"]
            | components["schemas"]["ResponseOutputItemDoneStreamingEvent"]
            | components["schemas"]["ResponseReasoningSummaryPartAddedStreamingEvent"]
            | components["schemas"]["ResponseReasoningSummaryPartDoneStreamingEvent"]
            | components["schemas"]["ResponseContentPartAddedStreamingEvent"]
            | components["schemas"]["ResponseContentPartDoneStreamingEvent"]
            | components["schemas"]["ResponseOutputTextDeltaStreamingEvent"]
            | components["schemas"]["ResponseOutputTextDoneStreamingEvent"]
            | components["schemas"]["ResponseRefusalDeltaStreamingEvent"]
            | components["schemas"]["ResponseRefusalDoneStreamingEvent"]
            | components["schemas"]["ResponseReasoningDeltaStreamingEvent"]
            | components["schemas"]["ResponseReasoningDoneStreamingEvent"]
            | components["schemas"]["ResponseReasoningSummaryDeltaStreamingEvent"]
            | components["schemas"]["ResponseReasoningSummaryDoneStreamingEvent"]
            | components["schemas"]["ResponseOutputTextAnnotationAddedStreamingEvent"]
            | components["schemas"]["ResponseFunctionCallArgumentsDeltaStreamingEvent"]
            | components["schemas"]["ResponseFunctionCallArgumentsDoneStreamingEvent"]
            | components["schemas"]["ErrorStreamingEvent"];
        };
      };
    };
  };
