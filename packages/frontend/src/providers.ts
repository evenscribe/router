...
export const PROVIDER_METADATA: Record<SupportedProvider, ProviderMetadata> = {
  ...
  anthropic: {
    ...
    iconPath:
      "M12 0L3 7.2v9.6L12 24l9-7.2V7.2L12 0zm6.5 14.9L12 19.7l-6.5-4.8V8.3L12 3.5l6.5 4.8v6.6z M8.5 9.8l3.5 2.6 3.5-2.6v4.4l-3.5 2.6-3.5-2.6V9.8z",
  ...
  "google-vertex": {
    ...
    fields: [
      ...
      { key: "region", label: "Region", placeholder: "us-central1", type: "text" },
      {
        ...
        type: "textarea",
        description: "The JSON key file for your GCP service account",
      },
    ],
  },
  "google-vertex-anthropic": {
  ...
  "amazon-bedrock": {
    ...
    iconPath:
      "M.75 10.812l10.5-6.636L1.59 1.897C1.148 1.656.75 1.835.75 2.353v8.46zm11.25-6.636l10.5 6.636V2.353c0-.518-.398-.697-.84-.456L12 4.176zM12 12.174l-9.75 6.15v3.822c0 .518.398.697.84.456l8.91-5.619v-4.81zm.75 4.81l8.91 5.618c.442.28.84.062.84-.456v-3.821l-9.75-6.15v4.81z",
    fields: [
...
/**
 * Check if a provider's keys object has all required fields filled in.
 * This is a pure validation function — it does not read from any storage.
 */
export function isProviderFullyConfigured(
  provider: SupportedProvider,
  keys: ProviderKeys | null | undefined,
): boolean {
